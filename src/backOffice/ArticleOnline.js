...
const ArticleOnline = () => {
 ...
 const  articles = [
    {
        id :"#1" ,nom:"Les oiseaux qui chantent"  , description :"l'oiseau qui chante le matin est très beau comme , il peut être même le plus beau de tout .",
                      ...
                      <tbody className="pt-4 border py-1 space-y-1 ">
                          {
                              articles.map((article) =>
                                  <tr className="rounded bg-white  hover:bg-gray-200 text-gray-900 py-3 space-y-1 border-b border-gray-900">
                                      ...
                                      <th className="px-3 py-5 mx-2 text-xl"><label className="">{article.nom}</label></th>
                                      <th className="px-3 py-5 mx-2 text-xl"><p className="">{article.description}</p></th>
                                      ...
                                      <th className="px-3 py-5 mx-2 flex flex-row">
                                          <Link to="/back-office/edit-article/id:"> 
                                           <button onClick={() => {
                                              ...
                                              <div className="flex flex-col justify-center ">
                                                 <div className=" w-full flex flex-col sm:flex-row md:flex-row lg:flex-row justify-center items-center ">
                                                          ...
                                                          <div className="w-full h-[300px] overflow-y-scroll px-3 border ">
                                                              ...
                                                              <div>
                                                                  <label>Nom</label>
                                                                  <input readOnly type="text" className=" px-2 py-1 h-10 w-full bg-gray-200 rounded-lg" value={article.nom} />
                                                              </div>
                                                              <div>
